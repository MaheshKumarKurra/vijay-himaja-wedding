...
const Controller = {
    ...
    this.modal =
        document.getElementById("celeV2Modal");

    this.title =
        document.getElementById("celeV2Title");

    this.body =
        document.getElementById("celeV2Body");

    this.instruction =
        document.getElementById("celeV2Instruction");

    this.hint =
        document.getElementById("celeV2Hint");
...
Controller.reset = function(){
    ...
    document
        .querySelectorAll(".cele-activity")
        .forEach(activity=>{
...
Controller.open = function(eventName){
    ...
    this.title.textContent =
    this.data[eventName].title;

    const completed =
    CelebrationState[eventName];
    ...
    if(completed){
        ...
        this.instruction.textContent =
            this.data[eventName].instruction;
