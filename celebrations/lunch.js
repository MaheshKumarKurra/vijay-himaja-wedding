...
Lunch.init=function(){
    ...
    this.activity.src=
"assets/images/lunch/lunch-activity-3.png";
...
`translate(-50%,-50%)
 rotate(${this.path.start.angle}deg)`;
...
Lunch.moveHand=function(progress){
    ...
    const top=
        ...
        (this.path.end.top-
        this.path.start.top)*progress;

    const angle =

    this.path.start.angle +
...
setTimeout(()=>{
    ...
    this.activity.src=
"assets/images/lunch/lunch-activity-2.png";
...
"assets/images/lunch/lunch-activity-1.png";
