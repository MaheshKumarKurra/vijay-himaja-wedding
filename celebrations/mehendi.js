...
this.maskImage.src =
    "assets/images/mehendi/rgb-mask.png";
...
Mehendi.getMaskColor=function(x,y){
    ...
    const maskX = Math.round(

        x * this.maskCanvas.width / this.canvas.width

    );

    const maskY = Math.round(

        y * this.maskCanvas.height / this.canvas.height

    );

    const pixel = this.maskCtx.getImageData(
...
Mehendi.completePetal=function(
